...
--в промежуток с 17 июня 2005 года по 25 июня 2005 года включительно, 
--и стоимость которых превышает 1.00.
--Платежи нужно отсортировать по дате платежа.

select * from payment where payment_date >= '2005-05-17' and payment_date <= '2005-05-25' and amount > 1.00 order by payment_date;
...
select * from film order by pg_column_size(fulltext) desc limit 3
...
select initcap(split_part(email, '@', 1)) as name, split_part(email, '@', 2) as server from customer 
